#====================================================================================================================
#  Apply NFS and Storage Queue Best Practice Advanced Settings to ESXi Hosts
#  Yellow = changed, Green = compliant, Red = error
#  Logs: Changes CSV, Baseline CSV, and TXT Log
#====================================================================================================================
...
# NFS and Disk Best Practice settings
$nfsSettings = @{
...
# Paths and logs (same base path as previous script)
...
("[{0}] Starting NFS Hardening Run" -f (Get-Date -Format 'yyyy-MM-dd HH:mm:ss')) | Out-File -FilePath $textLogPath -Encoding UTF8
...
# Final message
Write-Host "`n✅ NFS tuning complete." -ForegroundColor Cyan
